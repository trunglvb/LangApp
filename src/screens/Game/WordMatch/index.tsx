...
import OptionCard from '../CorrectWord/OptionCard';
import PressView from '../../../components/PressView/PressView';
import usePrevious from '../../../hooks/usePrevious';
import TopicCard from '../CorrectWord/TopicCard';
      ...
      <ScrollView
        ...
        <View>
          <AppText style={{fontSize: unit14}}>
            Combine the given characters into a word that makes sense with the
            given word.
          </AppText>
          <View>
            <AppText
        ...
        <LinearButton
          ...
          onPress={() => {
            navigation?.navigate('PlayWordMatchScreen', {
              type: typeResult?.key,
